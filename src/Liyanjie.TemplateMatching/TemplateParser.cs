...
namespace Liyanjie.TemplateMatching
{
    public static class TemplateParser
    {
        ...
        public static RouteTemplate Parse(string routeTemplate)
        {
            ...
            {
                throw new ArgumentException("InvalidRouteTemplate", nameof(routeTemplate));
            }
            ...
            while (context.Next())
            {
                if (context.Current == Separator)
                {
                    ...
                    throw new ArgumentException("CannotHaveConsecutiveSeparators", nameof(routeTemplate));
                }
                else
                {
        ...
        static bool ParseSegment(TemplateParserContext context, List<TemplateSegment> segments)
        {
            ...
            while (true)
            {
                if (context.Current == OpenBrace)
                {
                    if (!context.Next())
                    {
                        ...
                        context.Error = "MismatchedParameter";//Resources.TemplateRoute_MismatchedParameter;
                        return false;
                    }
        ...
        static bool ParseParameter(TemplateParserContext context, TemplateSegment segment)
        {
            context.Mark();
                ...
                if (context.Current == OpenBrace)
                {
                    ...
                    if (context.Next())
                    {
                        if (context.Current != OpenBrace)
                        {
                            ...
                            context.Error = "UnescapedBrace";// Resources.TemplateRoute_UnescapedBrace;
                            return false;
                        }
                    }
                    else
            ...
            {
                context.Error = "CatchAllCannotBeOptional";// Resources.TemplateRoute_CatchAllCannotBeOptional;
                return false;
            }
            ...
            if (templatePart.IsOptional && templatePart.DefaultValue != null)
            {
                ...
                context.Error = "OptionalCannotHaveDefaultValue";// Resources.TemplateRoute_OptionalCannotHaveDefaultValue;
                return false;
            }
        ...
        static bool ParseLiteral(TemplateParserContext context, TemplateSegment segment)
        {
            context.Mark();
        ...
        static bool IsAllValid(TemplateParserContext context, List<TemplateSegment> segments)
        {
            ...
            for (var i = 0; i < segments.Count; i++)
            {
                ...
                for (var j = 0; j < segment.Parts.Count; j++)
                {
                    ...
                    {
                        context.Error = "CatchAllMustBeLast";// Resources.TemplateRoute_CatchAllMustBeLast;
                        return false;
                    }
                }
            }
        ...
        static bool IsSegmentValid(TemplateParserContext context, TemplateSegment segment)
        {
            ...
            for (var i = 0; i < segment.Parts.Count; i++)
            {
                ...
                {
                    context.Error = "CannotHaveCatchAllInMultiSegment";// Resources.TemplateRoute_CannotHaveCatchAllInMultiSegment;
                    return false;
                }
            }
            ...
            for (var i = 0; i < segment.Parts.Count; i++)
            {
                ...
                if (part.IsParameter && part.IsOptional && segment.Parts.Count > 1)
                {
                    ...
                    if (i == segment.Parts.Count - 1)
                    {
                        ...
                        {
                            segment.Parts[i - 1].IsOptionalSeparator = true;
                        }
                        else
                        {
                            ...
                            context.Error = string.Format(
                                "OptionalParameterCanbBePrecededByPeriod",//Resources.TemplateRoute_OptionalParameterCanbBePrecededByPeriod,
                    ...
                    else
                    {
                        ...
                        context.Error = string.Format(
                            "OptionalParameterHasTobeTheLast",//Resources.TemplateRoute_OptionalParameterHasTobeTheLast,
                            segment.DebuggerToString(),
            ...
            for (var i = 0; i < segment.Parts.Count; i++)
            {
                ...
                {
                    context.Error = "CannotHaveConsecutiveParameters";// Resources.TemplateRoute_CannotHaveConsecutiveParameters;
                    return false;
                }
        ...
        static bool IsValidParameterName(TemplateParserContext context, string parameterName)
        {
            if (parameterName.Length == 0)
            {
                context.Error = String.Format(CultureInfo.CurrentCulture,
                                              "InvalidParameterName",//Resources.TemplateRoute_InvalidParameterName,
                                              parameterName);
                return false;
            }
            ...
            {
                context.Error = String.Format(CultureInfo.CurrentCulture,
                                              "RepeatedParameter",//Resources.TemplateRoute_RepeatedParameter,
                                              parameterName);
                return false;
            }
        ...
        static bool IsValidLiteral(TemplateParserContext context, string literal)
        {
            //Debug.Assert(context != null);
            ...
            {
                context.Error = String.Format(CultureInfo.CurrentCulture,
                                              "InvalidLiteral",//Resources.TemplateRoute_InvalidLiteral,
                                              literal);
                return false;
            }
        ...
        static bool IsInvalidRouteTemplate(string routeTemplate)
        {
